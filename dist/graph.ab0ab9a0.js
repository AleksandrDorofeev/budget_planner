...
var center = {
  x: dimentions.width / 2 + 5,
  y: dimentions.height / 2 + 5
};
var svg = d3.select(".canvas").append("svg").attr("width", dimentions.width + 150).attr("height", dimentions.height + 150);
var graph = svg.append("g").attr("transform", "translate(".concat(center.x, ", ").concat(center.y, ")"));
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/graph.js"], null)
